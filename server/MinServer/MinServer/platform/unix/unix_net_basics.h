#ifndef unix_net_basics_h__
#define unix_net_basics_h__
	...
	class NetPort {
		...
		public:
			...
			static int socketError(int socketDescriptor) {
				 ...
				 // note, nOptionValue passed as an int pointer, not a char pointer as compared to windows
				 getsockopt(socketDescriptor, SOL_SOCKET, SO_ERROR, &nOptionValue, &nOptionValueLength);
