#ifndef MsgGameUserCharacterDeleteResult_h__
#define MsgGameUserCharacterDeleteResult_h__
...
/**
 * Response from server to notify the client whether or not deletion was successful.
 */

class MsgGameUserCharacterDeleteResult : public min::MinMessage {


	public:
		/** -. */
		unsigned int success;
		/** Id the of the character which was deleted or failed to delete. */
		...
		MsgGameUserCharacterDeleteResult(bool init = true) {
			msgId = FWSMessageIDs::MSGID_GAME_USER_CHARACTER_DELETE_RESULT;
			_msgMinLength = 10;
		...
		MsgGameUserCharacterDeleteResult(const unsigned char* buf) {
			msgId = FWSMessageIDs::MSGID_GAME_USER_CHARACTER_DELETE_RESULT;
			_msgMinLength = 10;
			_msgIsValid = true;
			valuesFromBytes(buf);
		...
		MsgGameUserCharacterDeleteResult(const unsigned char* buf, unsigned int totalLength) {
			msgId = FWSMessageIDs::MSGID_GAME_USER_CHARACTER_DELETE_RESULT;
			_msgMinLength = 10;
			_msgIsValid = true;
			length = totalLength;
		...
		virtual ~MsgGameUserCharacterDeleteResult() {}
