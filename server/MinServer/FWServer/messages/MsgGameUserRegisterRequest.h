#ifndef MsgGameUserRegisterRequest_h__
#define MsgGameUserRegisterRequest_h__
...
class MsgGameUserRegisterRequest : public min::MinMessage {
	...
	public:
		...
		MsgGameUserRegisterRequest(bool init = true) {
			msgId = FWSMessageIDs::MSGID_GAME_USER_REGISTER_REQUEST;
			_msgMinLength = 6;
		...
		MsgGameUserRegisterRequest(const unsigned char* buf) {
			msgId = FWSMessageIDs::MSGID_GAME_USER_REGISTER_REQUEST;
			_msgMinLength = 6;
			_msgIsValid = true;
			valuesFromBytes(buf);
		...
		MsgGameUserRegisterRequest(const unsigned char* buf, unsigned int totalLength) {
			msgId = FWSMessageIDs::MSGID_GAME_USER_REGISTER_REQUEST;
			_msgMinLength = 6;
			_msgIsValid = true;
			length = totalLength;
		...
		virtual ~MsgGameUserRegisterRequest() {}
